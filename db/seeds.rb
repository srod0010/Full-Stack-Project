...
user5 = User.create(username: 'Jon', password: "password", email:'jon@email.com', city: 'New York City', image: img1)
user6 = User.create(username: 'Safuh', password: "password", email:'safuh@email.com', city: 'Miami', image: img1)
user7 = User.create(username: 'Ali', password: "password", email:'ali@email.com', city: 'New York City', image: img3)
...
event4 = Event.create(name: 'Rich Table', date: '2019-03-21',  city: 'New York', location: "Kokkari Estiatorio", description: "Taverna-inspired cuisine served in a candlelit, wood-beamed dining room that lures a chic crowd.", host_id: user2.id)

event5 = Event.create(name: 'Zuni Cafe', date: '2019-03-05', city: 'New York', location: "799 NE 54th St", description: "Crowds eat Californian-Mediterranean fare (& a popular brunch) in an outdoor space screening films.", host_id: user3.id)
